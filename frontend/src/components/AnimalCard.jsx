...
const AnimalCard = ({ animal }) => {
  ...
  return (
    <div className="animal-card">
      ...
      <button className="more-details-button" onClick={() => setShowDetails(true)}>More Details</button>
          ...
          <div className="details-content">
            ...
            <div className="details-info">
              ...
              {animal.place_of_found && (
                <p><strong>Place Found:</strong> {animal.place_of_found}</p>
              )}
              {animal.diet && <p><strong>Diet:</strong> {animal.diet}</p>}
              {animal.weight_kg && <p><strong>Weight (kg):</strong> {animal.weight_kg}</p>}
              {animal.height_cm && <p><strong>Height (cm):</strong> {animal.height_cm}</p>}
            </div>
